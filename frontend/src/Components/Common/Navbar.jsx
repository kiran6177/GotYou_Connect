...
function Navbar() {
  ...
  return (
    <div
    className='fixed h-[6rem] w-screen border-b-2 border-black shadow-xl dark:shadow-[#ffffff36] flex justify-between bg-white dark:bg-black z-20'>
    <div className='h-full ml-5 flex items-center'>
        <Link to={"/"} className='h-[80%] dark:bg-white overflow-hidden z-10'>
            <img src="/assets/GotYouLogo.png" alt="" className='object-cover h-full' />
        </Link>
    </div>

    <div className='flex items-center mr-7 z-10 gap-10'>
                <NavLink to={"/friends"} className='text-[#3d3d3d] dark:text-white h-[45%] flex flex-col items-center '>
                ...
                <NavLink to={"/notifications"} className='text-[#3d3d3d] dark:text-white h-[45%] flex flex-col items-center'>
                ...
                <NavLink to={"/profile"} className='text-[#3d3d3d] dark:text-white h-[45%] flex flex-col items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 -960 960 960" width="100%" fill="currentColor">
                        <path
