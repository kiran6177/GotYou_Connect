...
function Feed() {
  ...
  return (
    <div className='pt-[6rem] px-[2rem] bg-gray-200 min-h-screen flex justify-center gap-8'>
      <div className='w-[20%]'>
        <div className='bg-white rounded-md p-8 mt-4 flex flex-col gap-3 shadow-2xl'>
      ...
      <div className='w-[45%] bg-white shadow-2xl p-[2rem] '>
